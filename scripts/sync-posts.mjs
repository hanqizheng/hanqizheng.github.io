...
for (const file of files) {
  ...
  const payload = {
    ...
    cover_src: post.coverSrc,
    cover_position: post.coverPosition,
    cover_text_tone: post.coverTextTone,
        ...
        await pool.query(
          `
            ...
            on conflict (locale, slug) do update set
              ...
              cover_text_tone = excluded.cover_text_tone,
