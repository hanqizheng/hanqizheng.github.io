---
title: TS思考 - 逆变与协变
slug: Covariant&Contravariant
author: Qizheng Han
publishedAt: 2022-01-31
status: published
excerpt: TypeScript思考篇又来了 之前听到同事分享`逆变与协变`，自己很感兴趣但一直没有去研究，今天就来康康～ extends
  开始前可能要准备一下基础知识。`extends`关键字在TS中非常常用，它有如下几个功能 - 继承类/类型 - 约束类型 - 分配律
  `extends`在TS中不光可以表示`类`的继承和拓展，
---
