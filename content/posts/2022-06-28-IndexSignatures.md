...
slug: IndexSignatures
author: Qizheng Han
publishedAt: 2022-06-28
status: published
excerpt: 久违的`TS思考`系列又来了。 今天带来的是`索引签名(Index Signatures)`。 什么是索引签名？ 一说起`索引签名(Index
  Signatures)`可能觉得自己没听说过。 但是我写一段 TS 代码，大概率见过。 对，这个就是索引签名。我们先来引入一下官方的概念。wait,
  官方没有具体概念？只给出了
---
