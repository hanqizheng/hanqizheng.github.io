...
status: published
excerpt: "今天的主题是`单元测试`。 说实话最开始我对单元测试一无所知，以至于我觉得单元测试`“没什么用”`。 今天就来 什么是单元测试
  来自`wikipedia`的定义： > In computer programming, unit testing is a software
  testing method by which "
---
