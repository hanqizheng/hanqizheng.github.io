...
status: published
excerpt: "说实话这对我来说是一个基本没啥印象的`ES6特性`。 平时开发中基本用不到，工作中也很少看到有人使用`Proxy`。
  而最近随着面试的增多，在问道`Vue双向数据绑定`时，总是会听到`Proxy`，所以今天来学一下～ Proxy是什么？ 先来放上MDN官方的解释： >
  The Proxy object enables "
---
