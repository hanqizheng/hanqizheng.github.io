---
title: 虚拟滚动 - 条！
slug: VirtualScrollbar
author: Qizheng Han
publishedAt: 2021-06-11
status: published
excerpt: 最近在写组件，遇到的第一个问题就是浏览器的`滚动条`。 记得之前就被滚动条长痛过一次了，这次决定短痛， 直接总计来写一个滚动条。
  什么？为什么要这么大费周章？滚动条这个磨人的小妖精，我觉得她值得... 起因 最近写 Table 的虚拟化组件，因为 Table 实际是计算出位置的一个个
  div 拼成的 Grid，所以在整
---
